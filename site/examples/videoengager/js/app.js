...
TogetherJS.hub.on("init-connection", function (msg) {
  $("#togetherJSOnOFF").prop( "checked", true );
});

$('#togetherJSOnOFF').mousedown(function() {
  if(this.checked) {
    TogetherJS(this);
    $("#togetherJSHideSidebar").prop( "checked", true );
  } else {
    TogetherJS(this);
...
$('#togetherJSHideSidebar').mousedown(function() {
  if(!this.checked) {
    $("#togetherjs-container").show();
  } else {
    $("#togetherjs-container").hide();
  }
});
